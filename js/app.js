(() => {
  ...
  window.addEventListener("load", function (e) {
    document.querySelector(".swiper, .swipers, swiperson ") &&
      (new ae(".swiper", {
        modules: [le, ce],
        effect: "fade",
  ...
  setTimeout(() => {
    ...
    document.querySelectorAll(".form__btn").forEach((e) => {
      e.addEventListener("click", function () {
        document.querySelector("._form-error") &&
